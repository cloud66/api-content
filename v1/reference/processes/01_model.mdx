...
<Model>
    ...
    <ModelProperty name="servers" type="number">
        The number of server instances of this process running on each server. This helps in understanding the distribution of the process across the infrastructure.
    </ModelProperty>
</Model>
